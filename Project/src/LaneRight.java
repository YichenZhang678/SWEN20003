...
public class  LaneRight {
    private final static int WINDOW_HEIGHT = 768;
    private final static int MAX_NOTES = 100;
    private final static int MAX_HOLD_NOTES = 20;
    private final Image RIGHT_IMAGE = new Image("res/LaneRight.png");
    private final Image RIGHT_NOTE_IMAGE = new Image("res/noteRight.png");
    private final Image RIGHT_HOLD_NOTE_IMAGE = new Image("res/holdNoteRight.png");
    ...
    public LaneRight(int LANE_POSITION_X, int LANE_POSITION_Y, int SYMBOL_POSITION_Y) {
    ...
    public void paintCoordinator() {
        RIGHT_IMAGE.draw(getLaneCoordinatorX(), getLaneCoordinatorY());
    }
    ...
    public void paintNoteAndHoldNote() {
        ...
        for (int i = 0; i < countNotes; i++) {
            notes[i].animation(refreshNumber, RIGHT_NOTE_IMAGE, coordinator.x);
        }

        for (int i = 0; i < countHoldNotes; i++) {
            holdNotes[i].holdNoteAnimation(refreshNumber, RIGHT_HOLD_NOTE_IMAGE, coordinator.x);
        }
