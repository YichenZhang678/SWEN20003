...
public class  LaneLeft {
    private final static int WINDOW_HEIGHT = 768;
    private final static int MAX_NOTES = 100;
    private final static int MAX_HOLD_NOTES = 20;
    private final Image LEFT_IMAGE = new Image("res/LaneLeft.png");
    private final Image LEFT_NOTE_IMAGE = new Image("res/noteLeft.png");
    private final Image LEFT_HOLD_NOTE_IMAGE = new Image("res/holdNoteLeft.png");
    ...
    public LaneLeft(int LANE_POSITION_X, int LANE_POSITION_Y, int SYMBOL_POSITION_Y) {
    ...
    public void paintCoordinator() {
        LEFT_IMAGE.draw(getLaneCoordinatorX(), getLaneCoordinatorY());
    }
    ...
    public void paintNoteAndHoldNote() {
        ...
        for (int i = 0; i < countNotes; i++) {
            notes[i].animation(refreshNumber, LEFT_NOTE_IMAGE, coordinator.x);
        }

        for (int i = 0; i < countHoldNotes; i++) {
            holdNotes[i].holdNoteAnimation(refreshNumber, LEFT_HOLD_NOTE_IMAGE, coordinator.x);
        }
