...
public class  LaneUp {
    ...
    private final Image UP_IMAGE = new Image("res/LaneUp.png");
    private final Image UP_NOTE_IMAGE = new Image("res/noteUp.png");
    private final Image UP_HOLD_NOTE_IMAGE = new Image("res/holdNoteUp.png");
    ...
    public LaneUp(int LANE_POSITION_X, int LANE_POSITION_Y, int SYMBOL_POSITION_Y) {
    ...
    public void paintCoordinator() {
        UP_IMAGE.draw(getLaneCoordinatorX(), getLaneCoordinatorY());
    }
    ...
    public void paintNoteAndHoldNote() {
        ...
        for (int i = 0; i < countNotes; i++) {
            notes[i].animation(refreshNumber, UP_NOTE_IMAGE, coordinator.x);
        }

        for (int i = 0; i < countHoldNotes; i++) {
            holdNotes[i].holdNoteAnimation(refreshNumber, UP_HOLD_NOTE_IMAGE, coordinator.x);
        }
